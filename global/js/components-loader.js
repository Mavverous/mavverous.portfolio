...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadComponent('nav-container', basePath + 'navbar.html', function() {
        ...
        // Force navbar script execution directly
...
function initializeNavbar(isSubPage) {
    ...
    console.log('Logo image path set to:', logoImg.src);
    ...
    navLinks.forEach(link => {
        ...
        // Commissions link
        else if (pathAttr === 'commissions.html') {
            link.href = isSubPage ? './commissions.html' : 'pages/commissions.html';
        }
        // Anchor links
